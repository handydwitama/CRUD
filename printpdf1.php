...
$id_pembeli = $_GET['nama'];

class pdf extends FPDF{
    function Header()
    {
        $id_pembeli = $_GET['nama'];
        $tes = "Data Pembelian User : ".$id_pembeli;
        // Arial bold 15
...
$link = "SELECT list_pembelian.id_pembelian, list_pembelian.tanggal, username.nama, master_barang.nama_barang, 
      ...
      WHERE username.nama = '$id_pembeli' ORDER BY list_pembelian.id_pembelian ASC ";
...
$pdf=new PDF();
$pdf->AddPage();
$pdf->SetTitle("Data Pembelian User : ".$id_pembeli);
